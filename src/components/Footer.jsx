                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start space-x-3 text-muted-foreground group">
                                ...
                                <span className="group-hover:text-foreground transition-colors">Mysuru, Karnataka, India</span>
                            </li>
                            <li className="flex items-center space-x-3">
                                ...
                                <a href="tel:+918073490284" className="text-muted-foreground hover:text-primary transition-colors">
                                    +91 80734 90284
                                </a>
                            </li>
